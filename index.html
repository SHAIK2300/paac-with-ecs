...
<head>
        ...
        <!-- Page Title Here -->
        <title>Techie Horizon - Landing page | Website Coming Soon</title>
...
<!--        <link rel="stylesheet" href="./css/style-font1.css">-->
    ...
    <body id="menu" class="alt-bg">
        ...
        <!-- Site config : put launching date here
             data-date="01/31/2016 23:00:00"        Launching date
        ...
        <main class="page-main" id="mainpage">             
			...
			<div class="section page-home page page-cent" id="s-home">
				...
				<section class="content">
					...
					<header class="header">
						<div class="h-left">
							<h2>Techie <strong>Horizon</strong></h2>
						</div>
						<div class="h-right">
							<h3>DevOps <br>Training Institute</h3>
							<!-- <h4 class="subhead"><a href="#when">Website soon</a></h4> -->
						</div>
					</header>
				</section>
                ...
                <section class="content">
                    <div class="clock clock-countdown">
						<div class="site-config"
							 data-date="01/01/2024 23:00:00" 
							 data-date-timezone="+0"
							 ></div>
						<header class="header">
							Website <strong>Coming soon</strong>
						</header>
                        <div class="elem-left">
            ...
            <div class="section page-about page page-cent bg-color" data-bgcolor="#eceff1" id="s-about-us">
                <section class="content">
                    ...
                    <article class="text">
                        <p>Looking to jumpstart your career in <strong>DevOps?</strong> Look no further than our top-rated DevOps training institute!</p>
                        <p>We offer comprehensive training programs designed to equip you with the skills and knowledge needed to succeed in this fast-paced industry.</p>
                    </article>
                </section>
                <footer class="p-footer p-scrolldown">
                    <a href="#contact">
							...
							<div class="row">
								<div class="medium-6 columns left">
									<ul>
										<li>
											<h4>Email</h4>
											<p><a href="mailto:horizontechie27@gmail.com">horizontechie27@gmail.com</a></p>
										</li>
										<li>
											<h4>Address</h4>
											<p>Nellore, Hyderabad
											<br>Andhra Pradesh, Telangana</p>
										</li>
										<li>
											<h4>Phone</h4>
											<p>+91xxxxxxxxxx</p>
								...
								<div class="medium-6 columns social-links right">
									<ul>
										...
										<li class="show-for-medium-up">
											<h4>Website</h4>
											<p><a href="#">www.techiehorizon.com</a></p>
										</li>
										<li  class="show-for-medium-up">
											<h4>Find us on</h4>
										...
										<li>
											...
											<p class="small">Developed by <strong><a href="#">Hussain</a></strong>. All right reserved 2023</p>
										</li>
									</ul>
